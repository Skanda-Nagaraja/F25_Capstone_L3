...
class VulnerabilityComparator:
    ...
    def compare_scans(
        ...
        # Use (title, host) as unique identifier
...
class QALoop:
    ...
    def create_ansible_playbook(self, 
    ...
    def run_loop(self, max_iterations: int = 3, dry_run: bool = False) -> Dict[str, Any]:
        ...
        for iteration in range(1, max_iterations + 1):
            ...
            try:
                ...
                console.print(f"[yellow]Processing {len(high_severity_vulns)} vulnerabilities (severity >= {self.min_severity})[/yellow]")
                ...
                playbook_file = self.create_ansible_playbook(
                    remediations_file, vulns_file, iteration
                )
...
def main():
    ...
    parser.add_argument('--work-dir', default='qa_loop_work',
    ...
    parser.add_argument('--max-fixes', type=int, default=0,
